...
delivered_table_spec = 'bigquery-demo-285417:dataset_food_orders_latest.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'bigquery-demo-285417:dataset_food_orders_latest.other_status_orders'
